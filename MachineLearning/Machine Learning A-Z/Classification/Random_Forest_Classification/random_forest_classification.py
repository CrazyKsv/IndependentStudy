...
def random_forest_classifier_train(classifier, X_train, y_train):
...
def random_forest_classifier_test(classifier, X_test, y_test):
...
if __name__ == '__main__':
    ...
    classifier = random_forest_classifier_train(classifier, X_train, y_train)
    
    random_forest_classifier_test(classifier, X_test, y_test)
