...
def NB_classifier_train(classifier, X_train, y_train):
...
def NB_classifier_test(classifier, X_test, y_train):
...
if __name__ == '__main__':
    ...
    classifier = NB_classifier_train(classifier, X_train, y_train)
    NB_classifier_test(classifier, X_test, y_test)
